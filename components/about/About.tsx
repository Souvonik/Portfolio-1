      ...
      <div className="z-10">
        <div className="space-y-8 md:text-center">
          ...
          <p className="regular-paragraph mx-auto max-w-[835px]">
            Hi 👋, I&apos;m{' '}
            <span className="text-code text-yellow-600">Sayan Chakraborty</span>, a
            ...
            foundation in <span className="text-green-700">frontend</span>, 
            <span className="text-blue-600"> backend technologies</span> and<span className="text-purple-600"> generative ai</span>, I

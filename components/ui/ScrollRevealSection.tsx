    ...
    >
      ...
      >
        <p className="font-Silkscreen font-normal uppercase text-gray-400 md:mt-8 md:text-2xl">
          sayan chakraborty · software engineer
        </p>
        <div>
          <Link href="https://www.linkedin.com/in/sayan-chakraborty-3b5191286/" target="_blank">
      ...
      >
        {[
          ...
          },
          {
            text: "web apps",
            bg: "bg-revolver",
            textColor: "text-violet-400/85",
          },
          { text: "GenAI apps", bg: "bg-celtic", textColor: "text-dodgerblue" },
        ].map((item, i) => (
          <motion.p
            key={i}
            className={cn(
